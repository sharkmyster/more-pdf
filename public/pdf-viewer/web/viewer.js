...
const modules = [
        ...
        function attachDOMEventsToEventBus(eventBus) {
            ...
            eventBus.on("pagerendered", function (evt) {
                ...
                for (var i = 0; i < hyperlinks.length; i++) {
                    if (
                        !allowInternalLinks ||
                        hyperlinks[i].className != "internalLink"
                    ) {
            ...
            _createClass(PDFRenderingQueue, [
                ...
                },
                {
                    ...
                    value: function renderHighestPriority(
                        ...
                        if (
                            this.pdfViewer.forceRendering(currentlyVisiblePages)
                        ) {
                            return;
                        }
                        if (
    ...
    function (module, exports, __webpack_require__) {
        ...
        var PDFViewerApplication = {
            ...
            _initializeViewerComponents:
                function _initializeViewerComponents() {
                    ...
                    return new Promise(function (resolve, reject) {
                        ...
                        _this2.pdfViewer.setFindController(
                            _this2.findController
                        );
                        ...
                        sidebarConfig.pdfThumbnailViewer =
                            _this2.pdfThumbnailViewer;
                        sidebarConfig.pdfOutlineViewer =
                            _this2.pdfOutlineViewer;
            ...
            open: function open(file, args) {
                ...
                loadingTask.onPassword = function (updateCallback, reason) {
                    _this3.passwordPrompt.setUpdateCallback(
                        updateCallback,
                        reason
                    );
            ...
            download: function download() {
                ...
                this.pdfDocument
                    .getData()
                    .then(function (data) {
                        var blob = (0, _pdfjsLib.createBlob)(
                            data,
                            "application/pdf"
                        );
            ...
            load: function load(pdfDocument, scale) {
                ...
                firstPagePromise.then(function (pdfPage) {
                    _this6.loadingBar.setWidth(
                        _this6.appConfig.viewerContainer
                    );
                    if (
                        !_pdfjsLib.PDFJS.disableHistory &&
                        ...
                        _this6.pdfHistory.initialize(
                            _this6.documentFingerprint
                        );
                        if (_this6.pdfHistory.initialDestination) {
                            ...
                            _this6.initialBookmark =
                                _this6.pdfHistory.initialBookmark;
                        }
                    }
                    var initialParams = {
                    ...
                    Promise.all([storePromise, pageModePromise])
                        .then(function (_ref2) {
                            ...
                            var hash = _this6.viewerPrefs["defaultZoomValue"]
                                ...
                                : null;
                            var sidebarView =
                                _this6.viewerPrefs["sidebarViewOnLoad"];
                            if (
                                values.exists &&
                            ...
                            if (
                                pageMode &&
                                !_this6.viewerPrefs["disablePageMode"]
                            ) {
                                sidebarView =
                                    sidebarView ||
        ...
        var validateFileURL = void 0;
        {
            ...
            validateFileURL = function validateFileURL(file) {
                ...
                try {
                    ...
                    /*
                     *Commenting below code as this will prohibit displaying cloudfront hosted files
                     */
        ...
        function webViewerResize() {
            ...
            if (isFirefox) {
                if (
                    pdfViewer.container.scrollTop !== undefined &&
                    pdfViewer.container.scrollTop === 0 &&
                    pdfViewer.scroll.lastY !== undefined
                ) {
                    pdfViewer.container.scrollTop = pdfViewer.scroll.lastY;
                }
            }
            if (!pdfDocument) {
                return;
        ...
        var webViewerFileInputChange = void 0;
        {
            webViewerFileInputChange = function webViewerFileInputChange(evt) {
                ...
                if (
                    ...
                    fileReader.onload =
                        function webViewerChangeFileReaderOnload(evt) {
    ...
    function (module, exports, __webpack_require__) {
        ...
        var PDFLinkService = (function () {
            function PDFLinkService() {
                ...
                this.eventBus =
                    eventBus || (0, _dom_events.getGlobalEventBus)();
                this.baseUrl = null;
                this.pdfDocument = null;
                this.pdfViewer = null;
                    ...
                    value: function setHash(hash) {
                        ...
                        if (hash.indexOf("=") >= 0) {
                            ...
                            if ("nameddest" in params) {
                                if (this.pdfHistory) {
                                    this.pdfHistory.updateNextHashParam(
                                        params.nameddest
                                    );
                                }
            ...
            _createClass(PDFFindController, [
                {
                    ...
                    value: function reset() {
                        ...
                        this._firstPagePromise = new Promise(function (
                            resolve
                        ) {
                ...
                },
                {
                    ...
                    value: function calcFindMatch(pageIndex) {
                        ...
                        if (phraseSearch) {
                            this.calcFindPhraseMatch(
                                query,
                                pageIndex,
                                pageContent
                            );
                        } else {
                            this.calcFindWordMatch(
                                query,
                                pageIndex,
                                pageContent
                            );
                        ...
                        if (this.pageMatches[pageIndex].length > 0) {
                            this.matchCount +=
                                this.pageMatches[pageIndex].length;
                    ...
                    value: function extractText() {
                        ...
                        var _loop = function _loop(i, ii) {
                            ...
                            promise = promise.then(function () {
                                return _this2.pdfViewer
                                    .getPageTextContent(i)
                                    .then(
                        ...
                        for (
                            var i = 0, ii = this.pdfViewer.pagesCount;
                            i < ii;
                            i++
                        ) {
                            _loop(i, ii);
                        ...
                        if (this.dirtyMatch) {
                            ...
                            for (var i = 0; i < numPages; i++) {
                                ...
                                if (!(i in this.pendingFindMatches)) {
                                    ...
                                    this.extractTextPromises[i].then(function (
                                        pageIdx
                                    ) {
                                        delete _this4.pendingFindMatches[
                                            pageIdx
                                        ];
            ...
            _createClass(PDFAttachmentViewer, [
                ...
                },
                {
                    ...
                    value: function render(_ref2) {
                        ...
                        var names = Object.keys(attachments).sort(function (
                            a,
                            b
                        ) {
                            return a
            ...
            _createClass(PDFDocumentProperties, [
                ...
                },
                {
                    ...
                    value: function _parseDate(inputDate) {
                        ...
                        var month =
                            parseInt(dateToParse.substring(4, 6), 10) - 1;
        ...
        var PDFPageView = (function () {
            function PDFPageView(options) {
                ...
                this.enhanceTextSelection =
                    options.enhanceTextSelection || false;
            ...
            _createClass(PDFPageView, [
                ...
                },
                {
                    ...
                    value: function update(scale, rotation) {
                        ...
                        if (
                            this.canvas &&
                            _pdfjsLib.PDFJS.maxCanvasPixels > 0
                        ) {
                ...
                },
                {
                    ...
                    value: function draw() {
                        ...
                        var doesSVGExist = false;
                        for (var i = childNodes.length - 1; i >= 0; i--) {
                            var node = childNodes[i];
                            if (node instanceof SVGElement) {
                                doesSVGExist = true;
                                node.setAttribute("width", div.style.width);
                                node.setAttribute("height", div.style.height);
                            }
                        }
                        if (!doesSVGExist) {
                            var advancedAnnotationSVG =
                                document.createElementNS(
                                    "http://www.w3.org/2000/svg",
                                    "svg"
                                );
                            advancedAnnotationSVG.setAttribute(
                                "class",
                                "advancedAnnotationLayer"
                            );
                            advancedAnnotationSVG.setAttribute(
                                "width",
                                div.style.width
                            ...
                            if (
                                ...
                                div.insertBefore(
                                    advancedAnnotationSVG,
                                    this.annotationLayer.div
                                );
                            } else {
                                div.appendChild(advancedAnnotationSVG);
                            }
                        }
                ...
                },
                {
                    ...
                    value: function paintOnCanvas(canvasWrapper) {
                        ...
                        var sfx = (0, _ui_utils.approximateFraction)(
                            outputScale.sx
                        );
                        var sfy = (0, _ui_utils.approximateFraction)(
                            outputScale.sy
                        );
            ...
            _createClass(PDFPresentationMode, [
                ...
                },
                {
                    ...
                    value: function _mouseWheel(evt) {
                        ...
                        evt.preventDefault();
                        var delta = (0, _ui_utils.normalizeWheelEventDelta)(
                            evt
                        );
        ...
        var PDFSidebar = (function () {
            ...
            _createClass(PDFSidebar, [
                ...
                },
                {
                    ...
                    value: function _addEventListeners() {
                        ...
                        this.eventBus.on("attachmentsloaded", function (evt) {
                            ...
                            _this3.attachmentsButton.disabled =
                                !attachmentsCount;
                            if (attachmentsCount) {
                                ...
                                _this3.active === SidebarView.ATTACHMENTS
                            ) {
                                _this3.switchView(SidebarView.THUMBS);
                            }
                        });
                ...
                },
                {
                    ...
                    get: function get() {
                        return (
                            this.isOpen && this.active === SidebarView.THUMBS
                        );
                    },
                },
                {
                    ...
                    get: function get() {
                        return (
                            this.isOpen && this.active === SidebarView.OUTLINE
                        );
                    },
                },
                {
                ...
                [
                    ...
                    },
                    {
                        ...
                        value: function _getPageDrawContext() {
                            ...
                            var outputScale = (0, _ui_utils.getOutputScale)(
                                ctx
                            );
                            canvas.width =
                                (this.canvasWidth * outputScale.sx) | 0;
                            canvas.height =
                                (this.canvasHeight * outputScale.sy) | 0;
            ...
            _createClass(PDFThumbnailViewer, [
                ...
                },
                {
                    ...
                    value: function _cancelRendering() {
                        for (
                            var i = 0, ii = this._thumbnails.length;
                            i < ii;
                            i++
                        ) {
            ...
            _createClass(PDFViewer, [
                        ...
                        firstPagePromise
                            .then(function (pdfPage) {
                                ...
                                for (
                                    ...
                                    var pageView =
                                        new _pdf_page_view.PDFPageView({
                ...
                },
                {
                    ...
                    value: function scrollPageIntoView(params) {
                        ...
                        var allowNegativeOffset =
                            params.allowNegativeOffset || false;
                ...
                },
                {
                    ...
                    value: function getPagesOverview() {
                        var pagesOverview = this._pages.map(function (
                            pageView
                        ) {
                ...
                },
                {
                    ...
                    value: function reset() {
                        ...
                        return this._initializedPromise.then(function () {
                            _this2.prefs = (0, _ui_utils.cloneObj)(
                                _this2.defaults
                            );
                ...
                },
                {
                    ...
                    value: function _bindCursorToolsListener(buttons) {
                        this.eventBus.on("cursortoolchanged", function (evt) {
                            buttons.cursorSelectToolButton.classList.remove(
                                "toggled"
                            );
                            buttons.cursorHandToolButton.classList.remove(
                                "toggled"
                            );
                            switch (evt.tool) {
                                case _pdf_cursor_tools.CursorTool.SELECT:
                                    buttons.cursorSelectToolButton.classList.add(
                                        "toggled"
                                    );
                                    break;
                                case _pdf_cursor_tools.CursorTool.HAND:
                                    buttons.cursorHandToolButton.classList.add(
                                        "toggled"
                                    );
                                    break;
                            }
                    ...
                    value: function renderMatches(matches) {
                        ...
                        var isSelectedPage =
                            this.findController === null
                                ? false
                                : pageIdx ===
                                  this.findController.selected.pageIdx;
                ...
                },
                {
                    ...
                    value: function updateMatches() {
                        ...
                        for (var i = 0, len = matches.length; i < len; i++) {
                            ...
                            for (
                                var n = begin, end = match.end.divIdx;
                                n <= end;
                                n++
                            ) {
                                var div = textDivs[n];
                        ...
                        if (this.findController !== null) {
                            pageMatches =
                                ...
                                null;
                            pageMatchesLength = this.findController
                                .pageMatchesLength
